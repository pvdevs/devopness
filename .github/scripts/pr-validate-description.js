...
function validateResolvedIssuesSection(resolvedIssues) {
  ...
  if (
    ...
    fail(
      ...
      `Pull requests must specify at least one resolved GitHub issue (e.g., #123)
      or explicitly state "N/A" if no issue applies.

      The current content in the "GitHub issues resolved by this PR" section,
      "${issuesCheckList.raw}", does not meet this requirement.
